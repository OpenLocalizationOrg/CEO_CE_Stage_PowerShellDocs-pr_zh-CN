...
现在可以使用新的结构化的信息流传输脚本和其主机之间的结构化的数据。 **编写主机**也已更新发出到信息流，您可以立即捕获或静音其其输出。 常见的**-InformationVariable**和**-InformationAction**参数使用新 （以及对应的 WriteInformation API)**写入信息**cmdlet 使更多灵活性和功能。
